...
/**
 *@Filename: English.help.php
 *@Last Modified: 12/4/2010
 *@Author: Elite Bulletin Board <http://elite-board.us>
 *@Generator: EBB Language Tool v1.0
*/
...
If you haven\'t already, please register yourself so that you can join in on the discussions.';
